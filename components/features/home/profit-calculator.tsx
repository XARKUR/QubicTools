...
export const ProfitCalculator = memo(function ProfitCalculatorComponent() {
  ...
  const epochProgress = useMemo(() => {
    ...
    if (!isPoolDataAvailable()) {
      throw new Error(t('home.calculator.error.poolDataUnavailable'));
      return {
        performance: 0,
        totalCoins: 0,
        expectedDailyBlocks: 0,
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="nevermine">
                  {t('home.calculator.pool_nevermine')}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Label>{t('home.calculator.performance')}</Label>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <HelpCircle className="h-3.5 w-3.5 text-muted-foreground cursor-help shrink-0" />
                        ...
                        <TooltipContent>
                          <p className="w-[200px] text-xs">
                            {t('home.calculator.pattern.performance.tooltip')}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
