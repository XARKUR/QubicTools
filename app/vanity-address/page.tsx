...
import { SuccessSponsorDialog } from "@/components/features/shared/success-sponsor-dialog"
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <SuccessSponsorDialog 
          open={showSponsorDialog} 
          onOpenChange={setShowSponsorDialog}
          title={t('sponsor.success.vanityAddress.title')}
          description={t('sponsor.success.vanityAddress.description')}
        />
      </SidebarInset>
    </SidebarProvider>
  )
