    ...
    const fetchData = async () => {
      try {
        ...
        const transformedData: QubicToolData = {
          networkHashRate: toolData.data.pool_hashrate?.average?.average_qli_hashrate ?? 0,
